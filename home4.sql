...
-- Я не нашел ошибки в коде ниже. Перепровел все, посчитав руками кол-во лайков в таблице - у меня запрос выдает верное кол-во. 
-- Вот запрос только для подсчета лайков по медиафайлам:
